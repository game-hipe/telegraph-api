...
from ..abstract.page import PageMethods
from ..abstract.account import AccountMethods
...
class Telegraph(AccountMethods, PageMethods, BaseTelegraph):
    ...
    def create_account(self, *args, **kwargs):
        ...
        response = self._http.request(
            url=self._http.create_account, method="POST", json=account.model_dump()
        )
    ...
    def edit_account(self, *args, **kwargs):
        ...
        response = self._http.request(
            url=self._http.edit_account, method="POST", json=account.model_dump()
        )
        response.raise_for_status()
    ...
    def get_account_info(self, *args, **kwargs):
        ...
        response = self._http.request(
            url=self._http.get_account, method="POST", json=account.model_dump()
        )
        response.raise_for_status()
    ...
    def get_page_list(self, *args, **kwargs):
        ...
        response = self._http.request(
            url=self._http.get_page_list, method="POST", json=page.model_dump()
        )
        response.raise_for_status()
    ...
    def get_views(self, *args, **kwargs):
        ...
        response = self._http.request(
            url=self._http.get_views, method="POST", json=views.model_dump()
        )
        response.raise_for_status()
    ...
    def revoke_access_token(self, *args, **kwargs):
        ...
        response = self._http.request(
            url=self._http.revoke_accesstoken, method="POST", json=token.model_dump()
        )
        response.raise_for_status()
